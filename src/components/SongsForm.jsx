...
const SongsForm = ({ getSongs, showSuccessNotf, showFailNotf, setIsLoading, songSelected, deselectSong }) => {
    ...
    const submit = (data) => {
        ...
        if (songSelected) {
            ...
            axios.put(`http://localhost:8080/api/v1/songs/${songSelected.id}`, data)
                .then(() => {
                    getSongs();
    ...
    return (
        <Form style={{ maxWidth: 900 }} className="mx-auto mb-5" onSubmit={handleSubmit(submit)}>
            ...
            <Row>
                ...
                <Col>
                    <Form.Group className="mb-3" controlId="song.releseDate">
                        <Form.Label>Release Date</Form.Label>
                        <Form.Control type="date" {...register("releseDate")} />
                    </Form.Group>
                </Col>
            </Row>
